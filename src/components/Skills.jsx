...
const Skills = () => {
  const skills2 = [
    ...
    },
    {
      ...
      items: [
        ...
        { name: "TypeScript", icon: <SiTypescript className="text-4xl text-white" />, bg: "bg-blue-400" },
      ],
    },
    {
      category: "Database",
      items: [
        ...
        { name: "PostgreSQL", icon: <SiPostgresql className="text-4xl text-white" />, bg: "bg-blue-700" },
      ],
    },
    {
  ...
  return (
    <section id="skills" className="bg-[#111111] py-12 mx-auto w-full sm:px-10 md:px-24">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2">
            <div className="  bg-[#111111] transition duration-300  hover:shadow-2xl   p-4 sm:p-8   md:mb-0.5">
              ...
              <div className="flex flex-wrap gap-4">
                <div className="transition-all duration-500 hover:scale-y-105 hover:scale-x-105 bg-red-500 text-white p-4 rounded shadow-lg">
                  HTML
                </div>
                <div className="transition-all duration-500 hover:scale-y-105 hover:scale-x-105 bg-blue-500 text-white p-4 rounded shadow-lg">
                  CSS
                </div>
                <div className="transition-all duration-500 hover:scale-y-105 hover:scale-x-105 bg-pink-500 text-white p-4 rounded shadow-lg">
                  Tailwind
                </div>
                <div className="transition-all duration-500 hover:scale-y-105 hover:scale-x-105 bg-purple-500 text-white p-4 rounded shadow-lg">
                  Bootstrap
                </div>
                <div className="transition-all duration-500 hover:scale-y-105 hover:scale-x-105 bg-green-500 text-white p-4 rounded shadow-lg">
                  Daisy UI
                </div>
                <div className="transition-all duration-500 hover:scale-y-105 hover:scale-x-105 bg-yellow-500 text-white p-4 rounded shadow-lg">
                  React
                </div>
                <div className="transition-all duration-500 hover:scale-y-105 hover:scale-x-105 bg-purple-500 text-white p-4 rounded shadow-lg">
                  Redux
                </div>
                <div className="transition-all duration-500 hover:scale-y-105 hover:scale-x-105 bg-indigo-500 text-white p-4 rounded shadow-lg">
                  NextJS
                </div>
                <div className="transition-all duration-500 hover:scale-y-105 hover:scale-x-105 bg-pink-500 text-white p-4 rounded shadow-lg">
                  Express
                </div>
                <div className="transition-all duration-500 hover:scale-y-105 hover:scale-x-105 bg-gray-500 text-white p-4 rounded shadow-lg">
                  Node.js
                </div>
              </div>
            </div>
            ...
            <div className=" bg-[#111111]  transition duration-300 hover:shadow-xl  md:ml-0.5 md:mb-0.5 p-4 sm:p-8 ">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="bg-red-400 text-white p-4 rounded  shadow-lg transition-all duration-500 hover:scale-y-105 hover:scale-x-105">
                  C
                </div>
                <div className="bg-green-400 text-white p-4 rounded shadow-lg transition-all duration-500 hover:scale-y-105 hover:scale-x-105">
                  Java
                </div>
                <div className="bg-blue-400 text-white p-4 rounded shadow-lg transition-all duration-500 hover:scale-y-105 hover:scale-x-105">
                  JavaScript
                </div>
                <div className="transition-all duration-500 hover:scale-y-105 hover:scale-x-105 bg-yellow-500 text-white p-4 rounded shadow-lg text-wrap">
                  TypeScript
                </div>
              </div>
            </div>
            ...
            <div className=" bg-[#111111]  transition duration-300  hover:shadow-xl p-4 sm:p-8  ">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="bg-gray-600 text-white p-4 rounded  transition-all duration-500 hover:scale-y-105 hover:scale-x-105">
                  MySQL
                </div>
                <div className="bg-green-700 text-white p-4 rounded transition-all duration-500 hover:scale-y-105 hover:scale-x-105">
                  MongoDB
                </div>
                <div className="bg-blue-600 text-white p-4 rounded transition-all duration-500 hover:scale-y-105 hover:scale-x-105">
                  PostgreSQL
                </div>
              </div>
            </div>
            ...
            <div className=" bg-[#111111]  md:ml-0.5  transition duration-300  hover:shadow-xl p-4 sm:p-8  ">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="bg-purple-400 text-white p-4 rounded transition-all duration-500 hover:scale-y-105 hover:scale-x-105">
                  Figma
                </div>
                <div className="bg-pink-400 text-white p-4 rounded transition-all duration-500 hover:scale-y-105 hover:scale-x-105">
                  Pixso
                </div>
              </div>
            </div>
      ...
      <Marquee gradient={false} speed={50} pauseOnHover={true} className="flex ">
