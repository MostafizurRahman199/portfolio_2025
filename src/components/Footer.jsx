    ...
    <footer className="bg-black text-white py-12 px-6">
      <div className="max-w-6xl mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
        ...
        <div className="space-y-4">
          ...
          <p className="text-sm text-gray-400">
            Hi, I'm Mostafiz, a passionate web developer crafting responsive
        ...
        <div className="space-y-4">
          ...
          <ul className="space-y-2">
            <li className="text-gray-400">Email: mrahman202003@bscse.uiu.ac.bd</li>
            <li className="text-gray-400">Phone: +8801791604420</li>
      ...
      <div className="border-t border-gray-700 mt-8 pt-4 text-center">
        <p className="text-gray-400 text-sm">
          © {new Date().getFullYear()} Mostafiz. All rights reserved.
        </p>
      </div>
    </footer>
  );
